...
describe("EventsService", () => {
    ...
    describe("getEventsAttendedByUserIdPaginated", () => {
        it("should return a list of paginated events", async () => {
            ...
            expect(service.getEventsAttendedByUserIdPaginated(500, { limit: 1, currentPage: 1 })).resolves.toEqual({
                data: [],
                first: 1,
                last: 1,
                limit: 10,
            ...
            expect(mockedPaginate).toBeCalledWith(selectQb, { currentPage: 1, limit: 1 });
        });
    });
});
