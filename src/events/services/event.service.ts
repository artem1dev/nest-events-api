...
export class EventsService {
    ...
    public getEventsWithAttendeeCountQuery(): SelectQueryBuilder<Event> {
        return this.getEventsBaseQuery()
            ...
            .loadRelationCountAndMap("e.attendeeAccepted", "e.attendees", "attendee", (qb) =>
                qb.where("attendee.answer = :answer", { answer: AttendeeAnswerEnum.Accepted }),
            )
            .loadRelationCountAndMap("e.attendeeRejected", "e.attendees", "attendee", (qb) =>
                qb.where("attendee.answer = :answer", { answer: AttendeeAnswerEnum.Rejected }),
            )
            .loadRelationCountAndMap("e.attendeeMaybe", "e.attendees", "attendee", (qb) =>
    ...
    public async getEventsOrganizedByUserIdPaginated(
        ...
        return await paginate(this.getEventsOrganizedByUserIdQuery(userId), paginateOptions);
    }
    ...
    public async getEventsAttendedByUserIdPaginated(
        ...
        return await paginate(this.getEventsAttendedByUserIdQuery(userId), paginateOptions);
    }
